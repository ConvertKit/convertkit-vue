...
const Charlotte = {
  ...
  render: (h, {
    ...
    return h("div", [!hideWarnings && !ALLOWED_FORMATS.includes(format) ? h(Warning, {
      ...
      "class": `seva-form formkit-form charlotte ${className}`,
      "style": {
...
const Clare = {
  ...
  render: (h, {
    ...
    return h("div", [!hideWarnings && !ALLOWED_FORMATS$1.includes(format) ? h(Warning, {
      ...
      "class": `seva-form formkit-form clare ${className}`
    }, [h("div", {
      "attrs": {
        "data-style": "clean"
      }
...
const Cocoa = {
  ...
  render: (h, {
    ...
    return h("div", [!hideWarnings && !ALLOWED_FORMATS$2.includes(format) ? h(Warning, {
      ...
      "class": `seva-form formkit-form cocoa ${className}`,
      "style": {
...
const Mills = {
  ...
  render: (h, {
    ...
    return h("div", [!hideWarnings && !ALLOWED_FORMATS$3.includes(format) ? h(Warning, {
      ...
      "class": `seva-form formkit-form mills ${className}`,
      "style": {
...
const Monterey = {
  ...
  render: (h, {
    ...
    return h("div", [!hideWarnings && !ALLOWED_FORMATS$4.includes(format) ? h(Warning, {
      ...
      "class": `seva-form formkit-form monterey ${className}`,
      "style": {
...
const Pine = {
  ...
  render: (h, {
    ...
    return h("div", [!hideWarnings && !ALLOWED_FORMATS$5.includes(format) ? h(Warning, {
      ...
      "class": `seva-form formkit-form pine ${className}`,
      "style": {
        backgroundColor: 'rgb(255, 255, 255)',
        borderRadius: '6px'
      }
...
const Poplar = {
  ...
  render: (h, {
    ...
    return h("div", [!hideWarnings && !ALLOWED_FORMATS$6.includes(format) ? h(Warning, {
      ...
      "class": `seva-form formkit-form poplar ${className}`,
      "style": {
        backgroundColor: 'rgb(255 255 255)',
        borderRadius: '10px'
      }
...
const Powell = {
  ...
  render: (h, {
    ...
    return h("div", [!hideWarnings && !ALLOWED_FORMATS$7.includes(format) ? h(Warning, {
      ...
      "class": `seva-form formkit-form powell ${className}`,
      "style": {
        backgroundColor: 'rgb(255 255 255)',
        borderRadius: '8px'
      }
...
const Rainier = {
  ...
  render: (h, {
    ...
    return h("div", [!hideWarnings && !ALLOWED_FORMATS$8.includes(format) ? h(Warning, {
      ...
      "class": `seva-form formkit-form rainier ${className}`
    }, [h("div", {
      "class": "formkit-container",
      "attrs": {
        "data-style": "full"
